...
/*   Updated: 2023/02/21 18:05:33 by iomayr           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../headers/Channel.hpp"

Channel::Channel(): _channelName(""), _channelCreator(""), _channelkey(""), _isMode_O(false), _isMode_o(false), _isMode_v(false), _isMode_a(false), _isMode_i(false), _isMode_m(false), _isMode_n(false), _isMode_q(false), _isMode_p(false), _isMode_s(false), _isMode_r(false), _isMode_t(false), _isMode_k(false), _isMode_l(false), _isMode_b(false), _isMode_e(false), _isMode_I(false)
{}
